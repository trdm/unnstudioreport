...
/**
	...
	<b> Ячейка хранит: </b> \n
		...
		- текст, тип текста: \n
			- <b>текст</b> - простой текст, не интерпретируемый \n
			- <b>выражение</b> - весь текст интерпретируется в режиме вывода. Напирмер: "ПечДата" \n
				Данный текст может быть или выражением на встроенном языке или именем переменной. \n
			- <b>шаблон</b> - текстовая строка, в которой есть специальные вычисляемые теги. \n
		...
		- <b>Поведение длинного текста</b>: \n
			- <b>Авто</b> - Текст будет печататься в сторону его выравнивания, пока не встретит \n
			...
			- <b>Обрезать</b> - встретив границу ячейки текст просто обрежется.. \n
			- <b>Забивать</b> - если текст не помещается в ячейке, все литеры земенятся на <b>"@"</b>	 \n
			- <b>Переносить</b> - если текст не помещается в отведенную ему область, он будет
