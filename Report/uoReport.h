...
//#define uorNumberFloat 1
	...
	#define UORPT_SCALE_SIZE_DEF_VERTICAL 	15
	#define UORPT_SCALE_SIZE_DEF_HORIZONTAL 60
	#define UORPT_SCALE_FOLD_ITEM_SIZE 	10
#endif
...
class uoReportDrawHelper; //class uoReportDrawHelper;
...
{
	uoCP_Unknown = 0
	, uoCP_ContainsTab 			= 0x0001 /// Содержит '\t'
	, uoCP_ContainsLineBreak 	= 0x0002 /// Содержит '\n'
	, uoCP_HasUnion			 	= 0x0004 /// Ячейка участвует в объединении
	, uoCP_isFirstOfUnionCell	= 0x0008 /// Первая ячейка
	, uoCP_UnionCell_BackPoint	= 0x0010 /// Абстрактное объединение, указатель "назад"
	, uoCP_UnionCell_Normal		= 0x0020 /// Нормальное объединение, первая ячейка
	, uoCP_UnionCell_TextToCol	= 0x0040 /// Нормальное объединение, первая ячейка
};
...
extern void uorScaleRectI(QRect& rct, qreal scale);
extern void uorZeroRectF(uorRect& rct);
extern void uorZeroPointI(QPoint& point);
