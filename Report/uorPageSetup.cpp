...
void uorPageSetup::setSettings(uorPagePrintSetings* pSetings)
{
	...
	m_leFieldsLeft->setText(QString("%1").arg(pSetings->m_fieldLeft_mm));
	m_leFieldsTop->setText(QString("%1").arg(pSetings->m_fieldTop_mm));
	m_leFieldsRight->setText(QString("%1").arg(pSetings->m_fieldRight_mm));
	m_leFieldsBottom->setText(QString("%1").arg(pSetings->m_fieldBottom_mm));

	m_leRTitleTop->setText(QString("%1").arg(pSetings->m_titleTopSize_mm));
	m_leRTitleBottom->setText(QString("%1").arg(pSetings->m_titleBotSize_mm));
...
void uorPageSetup::accept()
{
	...
	m_pagesSetings->m_fieldLeft_mm = m_leFieldsLeft->text().toInt();
	m_pagesSetings->m_fieldTop_mm = m_leFieldsTop->text().toInt();
	m_pagesSetings->m_fieldRight_mm  = m_leFieldsRight->text().toInt();
	m_pagesSetings->m_fieldBottom_mm = m_leFieldsBottom->text().toInt();
...
//	m_pagesSetings->m_scopeVal = m_leScalePunctual->text().toInt();
	...
	m_pagesSetings->m_titleTopSize_mm = m_leRTitleTop->text().toInt();
	m_pagesSetings->m_titleBotSize_mm = m_leRTitleBottom->text().toInt();
